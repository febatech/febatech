...
public class PropertyUtils
{
    ...
    private static final String TOMCAT_CONFIG_FOLDER = "catalina.base";
    /**
     * path to jboss config folder.
     */
    private static final String PROP_FILE_NAME = "dailystatusreport.properties";
    ...
    public static Properties loadProperties() throws URISyntaxException, IOException
    {
        ...
        String path = System.getProperty(TOMCAT_CONFIG_FOLDER);
        if(StringUtils.isBlank(path)){
            LOGGER.debug("Unable to get the path from the System Property:" + TOMCAT_CONFIG_FOLDER);
        }
...
//                InputStream inputStream = url.openStream();
    ...
    public static String getLatestConfigValue(String key)
    {
        ...
        String path = System.getProperty(TOMCAT_CONFIG_FOLDER) + PROP_FILE_NAME;
        LOGGER.debug(" Property file present in following path :" + path);
        try
        {
            URL url = new URL(path);
