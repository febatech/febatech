		                        ...
		                        <table class="table table-bordered">
		                            ...
		                            <tbody>
		                                ...
		                                <tr>
		                                    ...
		                                    <td>${dailyStatusReportNFTObject.testDesignPhasePercentage}</td>
		                                </tr>
		                                <tr>
		                                    ...
		                                    <td>${dailyStatusReportNFTObject.executionPhasePercentage}</td>
		                                </tr>
		                                <tr>
		                                ...
		                                <tr>
		                                    ...
		                                    <td><fmt:formatNumber value="${(dailyStatusReportNFTObject.planingPhasePercentage + dailyStatusReportNFTObject.testDesignPhasePercentage + dailyStatusReportNFTObject.executionPhasePercentage + dailyStatusReportNFTObject.signOffAndClosurePhasePercentage)/4}" minFractionDigits="2" maxFractionDigits="2"/>
